...
It will create an executable in the bin/ directory called `test` which can then 
be ran without any arguments to run unit tests on the API and display the results.
