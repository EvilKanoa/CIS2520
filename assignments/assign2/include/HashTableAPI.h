...
typedef struct Node
{
	char *key; /* string that represents a piece of data in the table */
...
*@param key string that represents the data (eg 35->"hello")
 ...
 *@param key string that represents a piece of data in the table (eg 35->"hello")
 **/
